...
VALUES(SEQ_POINT.NEXTVAL, 26, 2000, 2000, '[구매 적립] 2000원 적립!', SYSDATE, ADD_MONTHS(SYSDATE, 1), '적립');
INSERT INTO TBL_POINT
VALUES(SEQ_POINT.NEXTVAL, 26, 5000, 3000, '[구매 적립] 3000원 적립!', SYSDATE, ADD_MONTHS(SYSDATE, 1), '적립');
INSERT INTO TBL_POINT(POINT_NUMBER, MEMBER_NUMBER, POINT_REMAIN, POINT_PRICE, POINT_CONTENT, POINT_DATE, POINT_TYPE)
VALUES(SEQ_POINT.NEXTVAL, 26, 4800, 200, '[구매 사용] 200원 사용!', SYSDATE, '사용');
INSERT INTO TBL_POINT
VALUES(SEQ_POINT.NEXTVAL, 3, 2000, '[구매 적립] 2000원 적립!', SYSDATE, ADD_MONTHS(SYSDATE, 1));

SELECT POINT_REMAIN FROM TBL_POINT
