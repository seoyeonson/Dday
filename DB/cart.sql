...
ALTER TABLE TBL_CART DROP FOREIGN KEY FK_CART_PRODUCT;
ALTER TABLE TBL_CART ADD CONSTRAINT FK_CART_PRODUCT FOREIGN KEY (PRODUCT_NUMBER) REFERENCES FK_CART_PRODUCT(PRODUCT_NUMBER) ON DELETE CASCADE;
